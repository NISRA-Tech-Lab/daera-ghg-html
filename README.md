...
An exemplar static dashboard presenting data stored on the [NISRA Data Portal](https://data.nisra.gov.uk/). Built with HTML, modular JavaScript, and R for data preparation.
